...
/* Mission System Settings */
	...
	DMS_TimeToFirstMission				= [30,60];				// [Minimum,Maximum] time between first mission spawn. | DEFAULT: 3-7 minutes.
	DMS_TimeBetweenMissions				= [60,180];				// [Minimum,Maximum] time between missions (if mission limit is not reached) | DEFAULT: 10-15 mins
...
/* DonkeyPunchDMS Custom Settings for Survivor AI*/
	...
	DMS_Bandit_Soldier_RoadkillRep		= 10;						// The amount of Respect gained/lost for running over a bandit soldier
...
/* DonkeyPunchDMS Custom Side Factions */
	...
	DMS_ai_freezingDistance				= 1800;						// If there are no players within this distance of the leader of an AI group, then the AI group will be "frozen".
	DMS_ai_unfreezingDistance			= 1700;						// If there are players within this distance of the leader of an AI group, then the AI group will be "un-frozen".
	...
	DMS_AI_AimCoef_moderate				= 0.75;						// "Custom Aim Coefficient" (weapon sway multiplier) for "moderate" AI
